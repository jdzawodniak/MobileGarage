...
def _get_dymo_objects():
    ...
    try:
        ...
        raise DymoTwinTurboError(
            f"DYMO COM not available: {msg}.{hint}"
        ) from e
...
def print_label(
    ...
    Args:
        ...
        roll: Roll.LEFT or Roll.RIGHT.
        fields: Optional dict of field name -> value for variable fields (e.g. {"TEXT1": "Hello"}).
        copies: Number of copies to print.
        show_dialog: If True, show print dialog.
        printer_name: Override printer name (default uses DEFAULT_PRINTER_NAMES for roll).
    """
...
def print_to_both_rolls(
    ...
    Args:
        ...
        fields_left: Variable fields for the left roll (e.g. {"TEXT1": "Left Roll"}).
